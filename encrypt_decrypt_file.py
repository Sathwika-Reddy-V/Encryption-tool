...
def open_document():
    document_url = "Project_Information.pdf"  
...
open_button = tk.Button(window, text="Project Info", width=10, height=2, bg="red", fg="white",
                        font=("Arial", 10, "bold"), command=open_document)
...
image_label = tk.Label(window, image=image, width=100, height=100)
